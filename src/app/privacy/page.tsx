    ...
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p className="text-sm mt-3">Kontakta oss på <a href={`mailto:${CONTACT_EMAIL}`} className="text-blue-600 hover:underline">{CONTACT_EMAIL}</a> för att utöva dina rättigheter. Du har också rätt att lämna klagomål till <a href="https://www.imy.se" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Integritetsskyddsmyndigheten (IMY)</a>.</p>
        </section>
